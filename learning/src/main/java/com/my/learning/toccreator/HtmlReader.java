...
public class HtmlReader {
    ...
    public static Collection<Catalog> readCatalog(File htmlFile) throws URISyntaxException, FailingHttpStatusCodeException, MalformedURLException, IOException{
        WebClient webClient = new WebClient();
        // 启动 js 解释器
        webClient.getOptions().setJavaScriptEnabled(true);
        // 禁用 css 支持
        webClient.getOptions().setCssEnabled(false);
        URI uri = new URIBuilder().setScheme("file").setPath(htmlFile.getPath()).build();
