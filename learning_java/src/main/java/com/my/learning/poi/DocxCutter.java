            ...
            if (paragraphCountList != null && paragraphCountList.size() > 0) {
                ...
                for (int i=0; i < paragraphCountList.size(); i++) {
                    ...
                    if (paragraphs != null && paragraphs.size() > 0) {
                        ...
                        //Write the file
                        String outputFolder = "C:\\Users\\guoenjing\\Desktop\\temp\\doc-temp";
                        String outputFile = "TestDocOutput"+docCount+".docx";
                        FileOutputStream outputStream = new FileOutputStream(new File(outputFolder, outputFile));
